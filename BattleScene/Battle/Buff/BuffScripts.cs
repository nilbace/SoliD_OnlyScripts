...
public enum E_BuffType
{
    ...
    Electrocution, Burn, Posion, HeadShot, SharpShooter, ReaperMark, DemonicWhisper, DarkMagic, SugarRush, CombatStance,
}
...
public class BuffFactory
{
    public static BuffBase GetBuffByType(E_BuffType buffType, float amount)
    {
        switch (buffType)
        {
            ...
            case E_BuffType.SugarRush:
                return new SugarRush(1);
...
{
    public SugarRush(float stack) : base(E_BuffType.SugarRush, -1, stack,
...
{
    public CombatStance(float stack) : base(E_BuffType.CombatStance, -1, stack,
